...
interface MLInsightsProps {
  riskMetrics: Omit<RiskMetrics, 'f1Score'> & { 
    f1Score?: number 
  };
}
...
const MLInsights: React.FC<MLInsightsProps> = ({ riskMetrics }) => {
  ...
  const fraudRate = riskMetrics.fraudRate ?? 
    (riskMetrics.flaggedTransactions / riskMetrics.totalTransactions);
    
  const falsePositiveRate = riskMetrics.falsePositiveRate ?? 
    (riskMetrics.falsePositives / riskMetrics.flaggedTransactions);
